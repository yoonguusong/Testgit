...
from models_Check_parameter1 import ResearchModels
import time
import os.path
import os
...
# file_list = os.listdir('/home/bravo/workspace/YHJ/JS_Data/final_two_ch/'+ band + '/' + group)
# file_list.sort()
#
...
MODEL_SAVE_FOLDER_PATH = './bi_lstm_model_pm1/'
